/**
 * Dr. Soumya Pal — Academic Portfolio
 * Dark Theme Motion System (Brijesh-style)
 * 
 * Features:
...
function initCustomCursor() {
    ...
    const interactiveElements = document.querySelectorAll('a, button, .pill, .highlight-card, .teach-card, .research-card, .pub-item, .contact-card, .stat-chip, .timeline-card');
...
function initScrollAnimations(prefersReducedMotion) {
    ...
    // Research cards — special spring effect
